...
import { checkTrainingRequestExpiries } from './services/trainingExpiryService.js';
...
class TitanBot extends Client {
  ...
  setupCronJobs() {
    ...
    cron.schedule('* * * * *', runSafeTask('training_request_expiry', () => checkTrainingRequestExpiries(this)));
  }
